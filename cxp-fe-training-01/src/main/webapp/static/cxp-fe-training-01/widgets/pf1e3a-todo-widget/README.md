...
_note: This exercise is 3 of 6 in a series of exercises that follow on from each other and should not be used independently_
...
#### Steps
 ...
 - User should not be able to add more, until he marks one as done

#### Additional resources

 - [server-catalog-widgets.xml](catalog-pf1e3a-todo-widget.xml)
